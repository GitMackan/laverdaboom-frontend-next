...
export default function ErrorModal({
	...
	return (
		<Modal
			...
			className="absolute top-[50%] left-[50%] ml-[-50%] flex transform translate-y-[-50%] translate-x-[75%] max-w-full just p-[48px] items-center bg-white font-cursive text-[2.5rem] min-w-[40%] border-[red] border-[1px]"
			style={{
				overlay: {
